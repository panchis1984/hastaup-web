...
export default function PropertyDetailPage() {
  ...
  if (!property) {
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center gap-4 text-center px-4">
        ...
        <p className="text-gray-500 text-sm">El inmueble que buscás ya no está disponible o la URL es incorrecta.</p>
  ...
  const galleryImages: string[] = Array.isArray(property.images) ? property.images : [];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-sm">
              ...
              <div className="relative">
                ...
                />
                {/* Badge tipo operación (sobre la galería) */}
                <span className="absolute top-4 left-4 z-10 bg-white/90 backdrop-blur-sm text-gray-950 font-bold text-xs px-3 py-1.5 rounded-full shadow-sm uppercase tracking-wider">
                  {property.type}
                </span>
              </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sticky top-24">
              ...
              <p className="text-xs text-gray-500 mb-6">Enviá un mensaje directo al asesor inmobiliario.</p>
